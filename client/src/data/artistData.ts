...
export const releases: readonly Track[] = [
  { id: "01", slug: "dein-name-auf-nem-stein", title: "DEIN NAME AUF NEM STEIN", mood: "Night / memory", themes: ["Verlust", "Freundschaft", "Stille"], visualTheme: "loss", coverStyle: "track-stone", cover: originalCovers["01"], note: "Ein stiller Kader für Erinnerung ohne Pathos.", sunoId: "eb401eb1-fd65-4b66-b16f-e870042179e4", audioSrc: masterAsset("/manus-storage/DeinNameaufnemStein.mp3"), spotifyTrackId: "6PhrvPVoh3GccVCFd3OOFI" },
  { id: "02", slug: "was", title: "WAS?", mood: "Academic / absurd", themes: ["Ego", "Ironie", "Überlegenheit"], visualTheme: "ego", coverStyle: "track-was", cover: originalCovers["02"], note: "Präzision kippt mit Absicht ins Absurde.", sunoId: "26b45c1f-01d5-4ea9-b457-bd589793f3e0", spotifyTrackId: "2T9rEVgepfTVMPlISr5PWs" },
  { id: "03", slug: "p34nuts-regelt-das", title: "P34NUTS REGELT DAS", mood: "Control / comic", themes: ["Charisma", "Selbstironie", "Kontrolle"], visualTheme: "control", coverStyle: "track-controls", cover: originalCovers["03"], note: "Ein überernster Problemlöser in einer viel zu großen Geste.", sunoId: "ed79a111-18bf-4476-ad9d-0b01fabc7df3", spotifyTrackId: "11BiI7Uy0RNbp4f9OngiHr" },
  { id: "04", slug: "maskenball", title: "MASKENBALL", mood: "Elegant / alone", themes: ["Maske", "Einsamkeit", "Rolle"], visualTheme: "mask", coverStyle: "track-mask", cover: originalCovers["04"], note: "Außen ein Ritual, innen ein leerer Raum.", sunoId: "6fc6cffd-60cc-4440-81e0-4dfde2bd575a", spotifyTrackId: "30Y6wtrZkhCUfQM6NLQTNr" },
  { id: "05", slug: "ich-hasse-dich-zu-lieben", title: "ICH HASSE DICH (..ZU LIEBEN)", mood: "Cold / close", themes: ["Liebe", "Konflikt", "Distanz"], visualTheme: "conflict", coverStyle: "track-distance", cover: originalCovers["05"], note: "Nähe bleibt sichtbar, Einigkeit nicht.", sunoId: "b17a773d-3f48-47de-b196-aecd07c1bf2d", spotifyTrackId: "48Srr4WTAvoAKYDCB93qmL" },
  { id: "06", slug: "scheiss-auf-das-wetter", title: "SCHEISS AUF DAS WETTER", mood: "Wet / free", themes: ["Regen", "Freiheit", "Energie"], visualTheme: "weather", coverStyle: "track-weather", cover: originalCovers["06"], note: "Nasser Asphalt, keine Ausrede.", sunoId: "ec5d49f0-1b60-48ac-ad9a-5b062aee773a", spotifyTrackId: "4akEqomPfrPHVhHgKhRsrf" },
  { id: "07", slug: "ungefiltert", title: "UNGEFILTERT", mood: "Polished / broken", themes: ["Realität", "Fassade", "Social media"], visualTheme: "filter", coverStyle: "track-filter", cover: originalCovers["07"], note: "Die Oberfläche ist glatt. Die Reflexion nicht.", sunoId: "32dab6d3-798d-47ad-85c8-e35ebcfa6e8f", spotifyTrackId: "6JB2HrnpXUqNdV2Vj8zxj9" },
  ...
  { id: "10", slug: "zeitlupe", title: "ZEITLUPE", mood: "Slow / moving", themes: ["Zeit", "Stillstand", "Melancholie"], visualTheme: "time", coverStyle: "track-time", cover: originalCovers["10"], note: "Alles zieht vorbei. Ein Kader bleibt stehen.", sunoId: "9dea2819-94e4-4c9c-a298-8d4dc8427d12", spotifyTrackId: "7E9fhzpkQtNIUcwW9ZHgSw" },
  { id: "11", slug: "diamanten-im-staub", title: "DIAMANTEN IM STAUB", mood: "Dust / light", themes: ["Wert", "Druck", "Widerstand"], visualTheme: "value", coverStyle: "track-diamond", cover: originalCovers["11"], note: "Ein Lichtpunkt in Betonstaub.", sunoId: "44dff979-c72c-48e7-8cda-38fff8719434", spotifyTrackId: "7kJ1F1DlxA9WxcZr7Irvdc" },
  { id: "12", slug: "was-waere-wenn", title: "WAS WÄRE WENN?", mood: "Split / possible", themes: ["Entscheidung", "Hoffnung", "Alternative"], visualTheme: "choice", coverStyle: "track-choice", cover: originalCovers["12"], note: "Zwei Wege. Kein neutraler Blick zurück.", sunoId: "3278b841-77a3-449d-a4a7-83d005634486", spotifyTrackId: "4nOvGj8LtQnNEjxrwUOyFQ" },
  { id: "13", slug: "wie-sagt-man-lebewohl", title: "WIE SAGT MAN LEBEWOHL?", mood: "Quiet / warm", themes: ["Familie", "Abschied", "Erinnerung"], visualTheme: "farewell", coverStyle: "track-chair", cover: originalCovers["13"], note: "Ein leerer Stuhl hält den Raum zusammen.", sunoId: "9e6325b3-77d2-41fa-93a6-825abf56311b", spotifyTrackId: "0qqDTE1D7y757hlSwCLVhg" },
  { id: "14", slug: "p34nuts", title: "P34NUTS", mood: "Myth / playful", themes: ["Mythos", "Humor", "Selbstbild"], visualTheme: "myth", coverStyle: "track-myth", cover: originalCovers["14"], note: "Zu groß für den Rahmen. Genau deshalb im Rahmen.", sunoId: "8e9441ed-6c77-418b-bc38-3b75876b08b3", spotifyTrackId: "69Fh9Vg7bcRI0tzntuB6Vg" },
  { id: "15", slug: "vip-ohne-namen", title: "VIP OHNE NAMEN", mood: "Velvet / anonymous", themes: ["Nacht", "Status", "Identität"], visualTheme: "vip", coverStyle: "track-vip", cover: originalCovers["15"], note: "Ein Zugang ohne Gesicht.", sunoId: "c32ad553-cec4-4fa7-b22f-a2e851942d78", spotifyTrackId: "3j3aF3ww36DO4uh3Um94Tt" },
  { id: "16", slug: "guten-morgen-sonnenschein", title: "GUTEN MORGEN SONNENSCHEIN", mood: "Sweet / wrong", themes: ["Kontrast", "Unruhe", "Oberfläche"], visualTheme: "sunshine", coverStyle: "track-sun", cover: originalCovers["16"], note: "Zu hell, um beruhigend zu sein.", sunoId: "dadc52f8-b985-4ff4-8ddd-941c53c6d31d", spotifyTrackId: "2z0kI18Ggwy90h6Ue4A0sl" },
  { id: "17", slug: "die-therapie-wirkt", title: "DIE THERAPIE WIRKT", mood: "Calm / chaos", themes: ["Ironie", "Ordnung", "Chaos"], visualTheme: "therapy", coverStyle: "track-therapy", cover: originalCovers["17"], note: "Alles ist völlig entspannt. Fast.", sunoId: "018ede07-c894-4e31-accc-e6991141939a", spotifyTrackId: "3SY9fGu3gr9M5M6aD1wDxB" },
  { id: "18", slug: "handwerker-des-jahres", title: "HANDWERKER DES JAHRES", mood: "Workshop / dry", themes: ["Handwerk", "Selbstbewusstsein", "Comedy"], visualTheme: "craft", coverStyle: "track-workshop", cover: originalCovers["18"], note: "Eine Werkbank, eine Haltung, kein Prahlen.", sunoId: "744cbaeb-9d43-4132-863a-93c472a000bb", spotifyTrackId: "1P0r6IYPfChBFwTNIkNBBb" },
  ...
  { id: "22", slug: "wer-bin-ich", title: "WER BIN ICH?", mood: "Mirror / split", themes: ["Identität", "Zweifel", "Wahrheit"], visualTheme: "identity", coverStyle: "track-mirror", cover: originalCovers["22"], note: "Die Reflexion stimmt nicht ganz mit dir überein.", sunoId: "72153de1-a135-4d6d-b7b7-601ac88e915e", spotifyTrackId: "4X3Mnds1NKkfkFWhIEThCX" },
  ...
  { id: "24", slug: "der-reset-knopf", title: "DER RESET-KNOPF", mood: "Reset / direct", themes: ["Neustart", "Entscheidung", "Signal"], visualTheme: "signal", coverStyle: "track-signal", cover: masterAsset("/uploads/page-images/file_00000000b74c822fb6e25bade4e3085f.jpg"), note: "Ein neuer P34nuts-Track für den Moment, in dem alles auf Anfang springt.", sunoId: "5f4f9c71-2954-4e96-8619-7e7fdd4004e5", audioSrc: "/audio/DerReset-Knopf.mp3", spotifyTrackId: "2ZhU7JFU7tlB8Vaiob0qlB" },
];
