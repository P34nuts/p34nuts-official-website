...
const EDITABLE_FILES = [
  { path: "client/src/data/artistData.ts", label: "Artist-Daten", hint: "Songs, Manifest, Profil und Links" },
  { path: "client/src/index.css", label: "Design & Layout", hint: "Farben, Abstände und Mobile CSS" },
] as const;
