import { ArrowUpRight, BookOpen, Boxes, ExternalLink, FilePenLine, Github, LockKeyhole, Package, Rocket, ShieldCheck, Store, Workflow } from "lucide-react";
    ...
    <div className="mx-auto max-w-7xl">
      <header className="border-b border-white/15 pb-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <span className="inline-flex items-center gap-2 border border-emerald-400/30 bg-emerald-950/25 px-3 py-2 font-mono text-[.62rem] uppercase tracking-[.14em] text-emerald-200"><ShieldCheck className="size-3.5" aria-hidden="true" /> GitHub-basiert</span>
        </div>
      ...
      <div className="my-7 grid gap-3 md:grid-cols-3">
      ...
      <div className="grid gap-12">
        <Section eyebrow="01 / Artist Homepage" title="Inhalte ändern" description="Diese direkten GitHub-Wege öffnen die vorhandenen Inhaltsquellen. Nach dem Speichern entsteht ein Commit; die Pages-Veröffentlichung folgt über den bestehenden Workflow.">
        ...
        <Section eyebrow="02 / Gästebuch & öffentliche Signale" title="Community verwalten" description="Das bestehende serverseitige Gästebuch bleibt geschützt. Öffne dafür den vorhandenen Adminweg; die öffentliche Homepage bleibt auf GitHub Pages.">
        ...
        <Section eyebrow="03 / Merch Shop" title="Shop öffnen" description="Der Shop läuft als getrennte Render-Anwendung. Checkout, Clerk, Stripe, Printful, Bestellungen und TiDB bleiben dort geschützt und werden nicht über GitHub-Dateien manipuliert.">
