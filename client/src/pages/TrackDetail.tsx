...
export default function TrackDetail() {
  ...
  const platformPlayer = track.sunoId ? <><span className="track-source-badge">FULL TRACK AVAILABLE / SUNO</span><SunoPlayer track={track} />{spotifyUrl && <SpotifyPlayer track={track} />}</> : <div className="track-listen-status"><Play size={16} fill="currentColor" /><span>STREAMING / QUELLE AUSSTEHEND</span><small>Die Audio- und Plattformquelle wird nach Freigabe ergänzt.</small></div>;
