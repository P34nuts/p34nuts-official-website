...
describe("GitHub Pages standalone build", () => {
  it("uses the Vite base path, carries referenced media into the Pages artifact and preserves the Booking API origin", () => {
    ...
    expect(workflow).toContain("VITE_TRPC_API_ORIGIN: https://p34nutsart-jjmeco2k.manus.space");
